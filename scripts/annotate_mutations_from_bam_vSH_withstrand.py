### NOTEi by @ivan108: this is patched script to replace original script in exome_QC_plots pipeline repo
### Changes: added variable RECAL_BAM_EXT instead of hardcoded BAM filename "bwa.realigned.rmDups.recal"
