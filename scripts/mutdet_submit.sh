...
INTERVAL=/home/jocostello/shared/LG3_Pipeline/resources/All_exome_targets.extended_200bp.interval_list
...
do
	...
	#qsub -v NORMAL=${normid},TUMOR=${ID},TYPE=${samp_label},PATIENT=${patient},CONFIG=/home/jocostello/shared/LG3_Pipeline/FilterMutations/mutationConfig.cfg,INTERVAL=/home/jocostello/shared/LG3_Pipeline/resources/All_exome_targets.extended_200bp.interval_list ~/LG3/MutDet_output/MutDet_nonorm.pbs
	#echo "qsub -v NORMAL=${normid},TUMOR=${ID},TYPE=${samp_label},PATIENT=${patient} ~/LG3/MutDet_output/MutContext.pbs"
	#qsub -v NORMAL=${normid},TUMOR=${ID},TYPE=${samp_label},PATIENT=${patient} ~/LG3/MutDet_output/MutContext.pbs
