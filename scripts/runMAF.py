...
def runMAF(patient_ID, projectname, conversionfile):
  ...
  #UGfile = os.environ["LG3_INPUT_ROOT"] + "/" + os.environ["PROJECT"] + "/exomes_recal/" + patient_ID + "/germline/" + patient_ID + ".UG.snps.vcf"
  UGfile = os.environ["LG3_INPUT_ROOT"] + "/" + projectname + "/exomes_recal/" + patient_ID + "/germline/" + patient_ID + ".UG.snps.vcf"
