...
###
### /path/to/Align_fastq.sh <fastq1> <fastq2> <output SAMPLE> <sai1> <sai2>
##
#
...
assert_file_exists "${sai1}"
assert_file_exists "${sai2}"
...
echo "-------------------------------------------------"
echo "[Align] BWA alignment step2!"
echo "-------------------------------------------------"
