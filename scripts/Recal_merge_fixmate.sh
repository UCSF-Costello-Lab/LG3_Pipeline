...
patientID=$2
ilist=$3
TMP="${SCRATCH_ROOT}/${patientID}_tmp"
mkdir -p "$TMP"
...
echo "[Skipping] Merge BAM files..."

echo "[Skipping] Index new BAM file..."

echo "[Skipping] Create intervals for indel detection..."

echo "[Skipping] Indel realignment..."
