...
cat("qualinfofile ",qualinfofile,"\n")
cat("mutationsfile ",mutationsfile,"\n")
...
cat("Loading data from ",qualinfofile,"\n")
...
cat("Loading data from ",mutationsfile,"\n")
...
if (length(variants) <= 300){#this makes sure this section of code, which is computationally costly for lots of variants, is not executed for hypermutators
  ...
  for (i in 1:length(variants)){
	...
	cat("Too many variants (>300), skipped variant quality analysis \n")
}

cat("Writing table ",qualitystatsFileName,"... \n")
...
cat("Creating directory libraryQuality ...\n")
dir.create(paste(patientID,'_qualplots/libraryQuality',sep=''), showWarnings <- FALSE)
cat("Plotting libraryQuality/overall_basequality.pdf ....\n")
...
cat("Plotting libraryQuality/overall_mappingquality.pdf ...\n")
...
cat("Plotting libraryQuality/ref_v_alt_basequality.pdf ...\n")
...
cat("Plotting libraryQuality/ref_v_alt_mappingquality.pdf ...\n")
...
cat("Plotting VAFPatterns/commondrivers.pdf ...\n")
...
cat("Plotting VAFPatterns/calldistribution.pdf ... \n ")
...
cat("Creating directory variantSpectra...\n")
